...
function TooltipWrapper({ children, content, ...props }: TooltipPrimitive.Root.Props & { children: ReactNode; content: ReactNode }) {
	return (
		<Tooltip {...props}>
			{isValidElement(children) ? <TooltipTrigger render={children} /> : <TooltipTrigger>{children}</TooltipTrigger>}
